    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('catalog_set', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalog.Set')),
        ...
        migrations.AddField(
            model_name='listing',
            name='catalog_sets',
            field=models.ManyToManyField(through='market.SetInAListing', to='catalog.Set'),
        ),
    ]
